...
export const generateOptimizedPrompt = async (options: {
  ...
  const styleSpecificDirectives: Record<string, string> = {
    ...
    "Graphic Design": ' - Focus on creating a background composition perfectly suited for graphic design usage, such as banners, posters, advertising, or promotional materials. Emphasize generous clean negative space (copy space) for typography and logos, stylish geometric overlays, modern gradients, halftone patterns, subtle grid lines, or abstract shapes. The composition should serve as an ideal foundation for overlaying text, with strong visual hierarchy and a commercial, polished aesthetic.'
  };
