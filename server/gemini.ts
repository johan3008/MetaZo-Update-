...
export const generateOptimizedPrompt = async (options: {
  ...
  const randomSaltInjection = userCameraAngle
    ? `[CRITICAL CAMERA ANGLE (User Selected - DO NOT IGNORE): ALL prompt variations MUST strictly use this exact camera angle: "${userCameraAngle}". Do not randomize, substitute, or deviate from this camera perspective. ${randomLighting}, ${randomComp}, ${randomSeason}, ${randomColor}, Seed ID: ${seed}]`
    : `[Random Composition Base: ${randomAngle}, ${randomLighting}, ${randomComp}, ${randomSeason}, ${randomColor}, Seed ID: ${seed}]`;
