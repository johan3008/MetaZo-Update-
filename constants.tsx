...
export const MIRICANVAS_CATEGORIES: MiriCanvasCategory[] = [
...
export const DREAMSTIME_MAIN_CATEGORIES: DreamstimeCategory[] = [
  { id: 1, name: 'Abstract' },
  { id: 2, name: 'Animals' },
...
export const DREAMSTIME_SUB_CATEGORIES: DreamstimeSubCategory[] = [
  { id: 1, name: 'Backgrounds', parentId: 1 },
  { id: 2, name: 'Textures', parentId: 1 },
  { id: 3, name: 'Patterns', parentId: 1 },
  { id: 4, name: '3D Renders', parentId: 1 },
  { id: 5, name: 'Birds', parentId: 2 },
  { id: 6, name: 'Mammals', parentId: 2 },
  { id: 7, name: 'Marine Life', parentId: 2 },
  { id: 8, name: 'Insects', parentId: 2 },
  { id: 9, name: 'Reptiles & Amphibians', parentId: 2 },
  { id: 10, name: 'Pets', parentId: 2 },
  { id: 11, name: 'Wildlife', parentId: 2 },
  { id: 12, name: 'Modern Buildings', parentId: 3 },
  { id: 13, name: 'Historic Buildings', parentId: 3 },
  { id: 14, name: 'Landmarks', parentId: 3 },
  { id: 15, name: 'Interior Design', parentId: 3 },
  { id: 16, name: 'Industrial', parentId: 3 },
  { id: 17, name: 'Home', parentId: 3 },
  { id: 18, name: 'Music', parentId: 4 },
  { id: 19, name: 'Dance', parentId: 4 },
  { id: 20, name: 'Theater', parentId: 4 },
  { id: 21, name: 'Film & Cinema', parentId: 4 },
  { id: 22, name: 'Visual Arts', parentId: 4 },
  { id: 23, name: 'Office', parentId: 5 },
  { id: 24, name: 'Finance', parentId: 5 },
  { id: 25, name: 'Marketing', parentId: 5 },
  { id: 26, name: 'Teamwork', parentId: 5 },
  { id: 27, name: 'Corporate', parentId: 5 },
  { id: 28, name: 'School', parentId: 6 },
  { id: 29, name: 'Science', parentId: 6 },
  { id: 30, name: 'Books & Reading', parentId: 6 },
  { id: 31, name: 'Classroom', parentId: 6 },
  { id: 32, name: 'Fruits & Vegetables', parentId: 7 },
  { id: 33, name: 'Meals', parentId: 7 },
  { id: 34, name: 'Beverages', parentId: 7 },
  { id: 35, name: 'Cooking', parentId: 7 },
  { id: 36, name: 'Desserts & Sweets', parentId: 7 },
  { id: 37, name: 'Doctors & Nurses', parentId: 8 },
  { id: 38, name: 'Hospitals', parentId: 8 },
  { id: 39, name: 'Medicine', parentId: 8 },
  { id: 40, name: 'Fitness & Wellness', parentId: 8 },
  { id: 41, name: 'Christmas', parentId: 9 },
  { id: 42, name: 'New Year', parentId: 9 },
  { id: 43, name: 'Easter', parentId: 9 },
  { id: 44, name: 'Halloween', parentId: 9 },
  { id: 45, name: "Valentine's Day", parentId: 9 },
  { id: 46, name: 'Factory', parentId: 10 },
  { id: 47, name: 'Engineering', parentId: 10 },
  { id: 48, name: 'Construction', parentId: 10 },
  { id: 49, name: 'Energy', parentId: 10 },
  { id: 50, name: 'Manufacturing', parentId: 10 },
  { id: 51, name: 'Landscapes', parentId: 11 },
  { id: 52, name: 'Forests', parentId: 11 },
  { id: 53, name: 'Mountains', parentId: 11 },
  { id: 54, name: 'Ocean & Sea', parentId: 11 },
  { id: 55, name: 'Weather', parentId: 11 },
  { id: 56, name: 'Flowers & Plants', parentId: 11 },
  { id: 57, name: 'Electronics', parentId: 12 },
  { id: 58, name: 'Tools', parentId: 12 },
  { id: 59, name: 'Furniture', parentId: 12 },
  { id: 60, name: 'Toys', parentId: 12 },
  { id: 61, name: 'Isolated Objects', parentId: 12 },
  { id: 62, name: 'Lifestyle', parentId: 13 },
  { id: 63, name: 'Portraits', parentId: 13 },
  { id: 64, name: 'Family', parentId: 13 },
  { id: 65, name: 'Emotions', parentId: 13 },
  { id: 66, name: 'Beauty & Fashion', parentId: 13 },
  { id: 67, name: 'Soccer', parentId: 14 },
  { id: 68, name: 'Basketball', parentId: 14 },
  { id: 69, name: 'Tennis', parentId: 14 },
  { id: 70, name: 'Fitness', parentId: 14 },
  { id: 71, name: 'Extreme Sports', parentId: 14 },
  { id: 72, name: 'Destinations', parentId: 15 },
  { id: 73, name: 'Transportation', parentId: 15 },
  { id: 74, name: 'Hotels', parentId: 15 },
  { id: 75, name: 'Culture', parentId: 15 }
];

export type AppLanguage = 'en' | 'id';

export const getDailyLimit = (): number => {
  return new Date() >= new Date('2026-07-01T00:00:00+07:00') ? 25 : 30;
};
