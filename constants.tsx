...
export const TRANSLATIONS = {
  en: {
    ...
    welcome_title: "Welcome to MetaZo PRO v1.2.1",
    ...
    activation_trial_active_desc: "You are in Free Trial mode. All features are unlocked with a limit of 30 generations per day. Activate officially to unlock unlimited generations.",
    ...
    prompt_trial_expired: "⚠️ Daily free trial limit (30 generates) reached. Please contact admin or enter activation code for unlimited processing.",
    prompt_trial_remaining: "Free trial 30 generates/day. Remaining quota today:",
    prompt_trial_times: "times",
    prompt_image_trial_label: "Today's Trial: Prompt Image",
    prompt_image_generate_count: "Generates",
    prompt_image_trial_expired: "⚠️ Daily free trial limit (30 generates) reached. Please contact admin or enter activation code for unlimited processing.",
    prompt_image_trial_remaining: "Free trial 30 generates/day. Remaining quota today:",
    prompt_image_trial_times: "times",
    prompt_video_trial_label: "Today's Trial: Prompt Video",
    prompt_video_generate_count: "Generates",
    prompt_video_trial_expired: "⚠️ Daily free trial limit (30 generates) reached. Please contact admin or enter activation code for unlimited processing.",
    prompt_video_trial_remaining: "Free trial 30 generates/day. Remaining quota today:",
    prompt_video_trial_times: "times",
    image_check_trial_label: "Today's Trial: Image Quality Audit",
    image_check_generate_count: "Audits",
    image_check_trial_expired: "⚠️ Daily free trial limit (30 audits) reached. Please contact admin or enter activation code for unlimited processing.",
    image_check_trial_remaining: "Free trial 30 audits/day. Remaining quota today:",
    ...
    prompt_error_trial: "Trial Limit Exceeded. You have reached the maximum limit of 30 Prompt Text generates today. Please contact admin or enter activation code for unlimited processing.",
    ...
    qc_drop_images_here: "Drop Images Here",
    qc_release_images: "Release Images",
    qc_multiple_upload: "Multiple Upload Supported",
    ...
    qc_info_empty: "Please upload images first to start the curation audit process",
  ...
  id: {
    ...
    custom_prompt_optional: "Target Kata Kunci (Opsional):",
    custom_prompt_placeholder: "Contoh: 'Biru, Laut, Musim Panas'.",
    ...
    sidebar_image_check: "Cek Gambar",
    ...
    welcome_title: "Selamat Datang di MetaZo PRO v1.2.1",
    welcome_subtitle: "Stock Asset Optimizer",
    ...
    activation_trial_active_desc: "Anda berada di mode Free Trial. Semua fitur terbuka dengan batasan maksimal 30 kali generate per hari. Lakukan aktivasi resmi untuk membuka semua fitur tanpa batas.",
    ...
    prompt_trial_expired: "⚠️ Batas trial gratis harian (30 generate) telah dicapai. Sila hubungi admin atau masukkan kode aktivasi untuk memproses tanpa batas.",
    prompt_trial_remaining: "Masa Trial gratis 30 generate/hari. Sisa kuota generate hari ini:",
    prompt_trial_times: "kali",
    prompt_image_trial_label: "Trial Hari Ini: Prompt Gambar",
    prompt_image_generate_count: "Generate",
    prompt_image_trial_expired: "⚠️ Batas trial gratis harian (30 generate) telah dicapai. Sila hubungi admin atau masukkan kode aktivasi untuk memproses tanpa batas.",
    prompt_image_trial_remaining: "Masa Trial gratis 30 generate/hari. Sisa kuota generate hari ini:",
    prompt_image_trial_times: "kali",
    prompt_video_trial_label: "Trial Hari Ini: Prompt Video",
    prompt_video_generate_count: "Generate",
    prompt_video_trial_expired: "⚠️ Batas trial gratis harian (30 generate) telah dicapai. Sila hubungi admin atau masukkan kode aktivasi untuk memproses tanpa batas.",
    prompt_video_trial_remaining: "Masa Trial gratis 30 generate/hari. Sisa kuota generate hari ini:",
    prompt_video_trial_times: "kali",
    image_check_trial_label: "Trial Hari Ini: Audit Kualitas",
    image_check_generate_count: "Audit",
    image_check_trial_expired: "⚠️ Batas trial gratis harian (30 audit) telah dicapai. Sila hubungi admin atau masukkan kode aktivasi untuk memproses tanpa batas.",
    image_check_trial_remaining: "Masa Trial gratis 30 audit/hari. Sisa kuota audit hari ini:",
    ...
    prompt_error_trial: "Batas Trial Terlampaui. Anda telah mencapai batas maksimal 30 kali generate Prompt Teks hari ini. Sila hubungi admin atau masukkan kode aktivasi untuk memproses tanpa batas.",
    ...
    qc_upload_hub: "Upload Hub",
    qc_drop_images_here: "Drop Gambar Di Sini",
    qc_release_images: "Lepaskan Gambar",
    qc_multiple_upload: "Mendukung Multiple Upload",
    ...
    qc_info_empty: "Silahkan upload gambar dulu untuk memulai proses audit kurasi",
